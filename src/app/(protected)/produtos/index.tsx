...
import { ProdutosStackParamList } from "./ProdutosStack"; // <- importe do local correto
  ...
  return (
    <View className="flex-1 pt-6 px-6">
      <TouchableHighlight
        ...
        onPress={() => navigation.navigate("AdicionarProduto")} // <- o nome da rota como definido no stack
      >
