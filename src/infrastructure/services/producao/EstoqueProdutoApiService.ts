...
export class EstoqueProdutoApiService implements IEstoqueProdutoApiService {
  ...
  async inserir(dto: EstoqueProdutoInserirDTO): Promise<void> {
    try {
      await HttpClient.post<EstoqueProdutoInserirDTO, void>(
        "estoqueProduto/inserir",
        dto
      );
    } catch (error: any) {
  ...
  async atualizar(dto: EstoqueProdutoAtualizarDTO): Promise<void> {
    try {
      await HttpClient.post<EstoqueProdutoAtualizarDTO, void>(
        "estoqueProduto/atualizar",
        dto
      );
    } catch (error: any) {
